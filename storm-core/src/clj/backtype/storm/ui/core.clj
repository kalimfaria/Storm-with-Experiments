...
(defn component-page
  ...
  (with-nimbus nimbus
    (let [window (if window window ":all-time")
      ...
      (log-message "\nLogging the topology: "  topology)
      (log-message "\nLogging the topology-conf: "  topology-conf)
      (log-message "\nLogging the summ: "  summ)
      (log-message "\nLogging the type: "  type)
      (log-message "\nLogging the summs: "  summs)
      (log-message "\nLogging the spec: "  spec)
      (log-message "\nLogging the errors: "  errors)
