 ...
 public class ProcessingTopology_8_WithAcking {
     public static void main(String[] args) throws Exception {
         ...
         builder.setSpout("spout_head", new RandomLogSpout_WithAcking(), paralellism + 2).setNumTasks(20);// +2 by Faria

         builder.setBolt("bolt_transform", new TransformBolt_WithAcking(), paralellism+2).shuffleGrouping("spout_head").setNumTasks(20);
         builder.setBolt("bolt_filter", new FilterBolt_WithAcking(), paralellism + 2).shuffleGrouping("bolt_transform").setNumTasks(20);
         ...
         builder.setBolt("bolt_join2", new TransformBolt_WithAcking(), paralellism+2).shuffleGrouping("bolt_transform").setNumTasks(20);
